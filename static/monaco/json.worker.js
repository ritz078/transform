      ...
      var simpleWorker_SimpleWorkerServer = /** @class */ (function() {
        ...
        SimpleWorkerServer.prototype.initialize = function(
          ...
          if (this._requestHandler) {
            ...
            var methods = [];
            for (
              var _i = 0, _a = getAllPropertyNames(this._requestHandler);
              _i < _a.length;
              _i++
            ) {
              var prop = _a[_i];
     ...
     */
          ...
          for (var i = -1 /* !!!! */, len = rawChanges.length; i < len; i++) {
            ...
            while (
              ...
              if (originalLine !== modifiedLine) {
                ...
                {
                  var originalStartColumn = diffComputer_LineMarkerSequence._getFirstNonBlankColumn(
                    originalLine,
                    1
                  );
                  var modifiedStartColumn = diffComputer_LineMarkerSequence._getFirstNonBlankColumn(
                    modifiedLine,
                    1
                  );
                ...
                {
                  var originalEndColumn = diffComputer_LineMarkerSequence._getLastNonBlankColumn(
                    originalLine,
                    1
                  );
                  var modifiedEndColumn = diffComputer_LineMarkerSequence._getLastNonBlankColumn(
                    modifiedLine,
                    1
                  );
      ...
      var mirrorTextModel_MirrorTextModel = /** @class */ (function() {
        ...
        MirrorTextModel.prototype._ensureLineStarts = function() {
          if (!this._lineStarts) {
            ...
            this._lineStarts = new prefixSumComputer_PrefixSumComputer(
              lineStartValues
            );
          }
        };
      ...
      var CharacterSet = /** @class */ (function() {
        function CharacterSet() {
          this._actual = new characterClassifier_CharacterClassifier(
            0 /* False */
          );
        }
      ...
      function getClassifier() {
        if (_classifier === null) {
          _classifier = new characterClassifier_CharacterClassifier(
            0 /* None */
          );
 ...
 */
      ...
      (function(CompletionTriggerKind) {
        ...
        CompletionTriggerKind[(CompletionTriggerKind["TriggerCharacter"] = 1)] =
          "TriggerCharacter";
       ...
       *  Licensed under the MIT License. See License.txt in the project root for license information.
       *--------------------------------------------------------------------------------------------*/
      var editorSimpleWorker_extends =
        (undefined && undefined.__extends) ||
        (function() {
          var extendStatics = function(d, b) {
            extendStatics =
      ...
      var editorSimpleWorker_BaseEditorSimpleWorker = /** @class */ (function() {
        ...
        BaseEditorSimpleWorker.prototype.computeMoreMinimalEdits = function(
          ...
          for (var _i = 0, edits_1 = edits; _i < edits_1.length; _i++) {
            ...
            var editOffset = model.offsetAt(
              range_Range.lift(range).getStartPosition()
            );
        ...
        BaseEditorSimpleWorker.prototype.loadForeignModule = function(
          ...
          if (this._foreignModuleFactory) {
            ...
            var methods = [];
            for (
              var _i = 0, _a = getAllPropertyNames(this._foreignModule);
              _i < _a.length;
              _i++
            ) {
              var prop = _a[_i];
       ...
       * @internal
       */
      var editorSimpleWorker_EditorSimpleWorkerImpl = /** @class */ (function(
        _super
      ) {
        ...
        EditorSimpleWorkerImpl.prototype.acceptNewModel = function(data) {
          this._models[data.url] = new editorSimpleWorker_MirrorModel(
            uri_URI.parse(data.url),
            data.lines,
            data.EOL,
            data.versionId
          );
      ...
      function initialize(foreignModule) {
        ...
        initialized = true;
        var editorWorker = new editorSimpleWorker_EditorSimpleWorkerImpl(
          foreignModule
        );
      ...
      (function(Range) {
        ...
        function is(value) {
          ...
          return (
            Is.objectLiteral(candidate) &&
            main_Position.is(candidate.start) &&
            main_Position.is(candidate.end)
          );
        }
        Range.is = is;
      ...
      (function(Hover) {
        ...
        function is(value) {
          ...
          return (
            ...
            (value.range === void 0 || main_Range.is(value.range))
          );
        }
        Hover.is = is;
      })(Hover || (Hover = {}));
      ...
      (function(DocumentSymbol) {
        ...
        function is(value) {
          ...
          return (
            ...
            main_Range.is(candidate.range) &&
            main_Range.is(candidate.selectionRange) &&
      ...
      function format_format(documentText, range, options) {
        ...
        function newLineAndIndent() {
          return (
            eol + format_repeat(indentValue, initialIndentLevel + indentLevel)
          );
        }
        function scanNext() {
      ...
      var vscode_uri_URI = (function() {
        ...
        function URI(schemeOrData, authority, path, query, fragment) {
          if (typeof schemeOrData === "object") {
            ...
            this.path = vscode_uri_referenceResolution(
              this.scheme,
        ...
        URI.prototype.with = function(change) {
          ...
          return new _deps_vscode_uri_URI(
            scheme,
            authority,
            path,
            query,
        ...
        URI.parse = function(value) {
          ...
          return new _deps_vscode_uri_URI(
            match[2] || vscode_uri_empty,
            decodeURIComponent(match[4] || vscode_uri_empty),
            decodeURIComponent(match[5] || vscode_uri_empty),
            decodeURIComponent(match[7] || vscode_uri_empty),
            decodeURIComponent(match[9] || vscode_uri_empty)
          );
        };
        /**
     * Creates a new URI from a file system path, e.g. `c:\my\files`,
     ...
     */
      ...
      function vscode_uri_asFormatted(uri, skipEncoding) {
        ...
        if (fragment) {
          res += "#";
          res += !skipEncoding
            ? vscode_uri_encodeURIComponentFast(fragment, false)
            : fragment;
        }
        return res;
      }
      ...
      var SchemaCollector = /** @class */ (function() {
        ...
        SchemaCollector.prototype.include = function(node) {
          return (
            (this.focusOffset === -1 ||
              jsonParser_contains(node, this.focusOffset)) &&
            node !== this.exclude
          );
        };
          ...
          if (
            ...
            for (var _i = 0, _a = this.problems; _i < _a.length; _i++) {
              ...
              if (error.code === ErrorCode.EnumValueMismatch) {
                error.message = jsonParser_localize(
                  "enumWarning",
        ...
        JSONDocument.prototype.getMatchingSchemas = function(
          ...
          if (this.root && schema) {
            validate(
              this.root,
              schema,
              new jsonParser_ValidationResult(),
              matchingSchemas
            );
          }
      ...
      function validate(node, schema, validationResult, matchingSchemas) {
        ...
        function _validateStringNode(
          ...
          if (
            objects_isNumber(schema.minLength) &&
          ...
          if (
            objects_isNumber(schema.maxLength) &&
              ...
              case "uri-reference":
                {
                  ...
                  if (!node.value) {
                    errorMessage = jsonParser_localize(
                      "uriEmpty",
                      "URI expected."
                    );
                  } else {
                    try {
                      var uri = vscode_uri.parse(node.value);
        ...
        function _validateArrayNode(
          ...
          if (
            objects_isNumber(schema.minItems) &&
          ...
          if (
            objects_isNumber(schema.maxItems) &&
      ...
      function jsonParser_parse(textDocument, config) {
        ...
        function _parseArray(parent) {
          ...
          while (
            ...
            if (scanner.getToken() === 5 /* CommaToken */) {
              if (!needsComma) {
                _error(
                  jsonParser_localize("ValueExpected", "Value expected"),
              ...
              if (scanner.getToken() === 4 /* CloseBracketToken */) {
                if (needsComma) {
                  _errorAtRange(
                    jsonParser_localize("TrailingComma", "Trailing comma"),
              ...
              _error(
                jsonParser_localize("ExpectedComma", "Expected comma"),
            ...
            if (!item) {
              _error(
                jsonParser_localize("PropertyExpected", "Value expected"),
                ErrorCode.ValueExpected,
                null,
                [],
                [4 /* CloseBracketToken */, 5 /* CommaToken */]
        ...
        function _parseProperty(parent, keysSeen) {
          ...
          if (scanner.getToken() === 6 /* ColonToken */) {
            ...
            _error(
              jsonParser_localize("ColonExpected", "Colon expected"),
        ...
        function _parseObject(parent) {
          ...
          while (
            ...
            if (scanner.getToken() === 5 /* CommaToken */) {
              if (!needsComma) {
                _error(
                  jsonParser_localize("PropertyExpected", "Property expected"),
      ...
      var jsonCompletion_JSONCompletion = /** @class */ (function() {
        ...
        JSONCompletion.prototype.doComplete = function(
          ...
          if (
            ...
            overwriteRange = main_Range.create(
                ...
                Object.keys(schemaProperties_1).forEach(function(key) {
                  ...
                  if (
                    ...
                    var proposal = {
                      ...
                      documentation:
                        _this.fromMarkup(propertySchema.markdownDescription) ||
        ...
        JSONCompletion.prototype.addDefaultValueCompletions = function(
          ...
          if (isDefined(schema.default)) {
            ...
            collector.add({
              ...
              insertTextFormat: InsertTextFormat.Snippet,
              detail: jsonCompletion_localize(
      ...
      var jsonHover_JSONHover = /** @class */ (function() {
        ...
        JSONHover.prototype.doHover = function(document, position, doc) {
          ...
          var hoverRange = main_Range.create(
        ...
        function FilePatternAssociation(pattern) {
          try {
            this.patternRegExp = new RegExp(
              strings_convertSimple2RegExpPattern(pattern) + "$"
            );
          } catch (e) {
            // invalid pattern
      ...
      var jsonSchemaService_JSONSchemaService = /** @class */ (function() {
        ...
        JSONSchemaService.prototype.getRegisteredSchemaIds = function(filter) {
          return Object.keys(this.registeredSchemasIds).filter(function(id) {
            var scheme = vscode_uri.parse(id).scheme;
        ...
        JSONSchemaService.prototype.normalizeId = function(id) {
          ...
          return vscode_uri.parse(id).toString();
        };
        ...
        JSONSchemaService.prototype.loadSchema = function(url) {
          if (!this.requestService) {
            var errorMessage = jsonSchemaService_localize(
        ...
        JSONSchemaService.prototype.resolveSchemaContent = function(
          ...
          return resolveRefs(schema, schema, schemaURL, dependencies).then(
            function(_) {
              return new jsonSchemaService_ResolvedSchema(
                schema,
                resolveErrors
              );
            }
        ...
        JSONSchemaService.prototype.getSchemaForResource = function(
          ...
          if (document && document.root && document.root.type === "object") {
            ...
            if (schemaProperties.length > 0) {
              var schemeId = jsonParser_getNodeValue(
                schemaProperties[0].valueNode
              );
              if (
                schemeId &&
                strings_startsWith(schemeId, ".") &&
                this.contextService
              ) {
        ...
        JSONValidation.prototype.doValidation = function(
          ...
          var getDiagnostics = function(schema) {
            ...
            if (typeof commentSeverity === "number") {
              var message_1 = jsonValidation_localize(
                "InvalidCommentToken",
          ...
          if (schema) {
            ...
            return this.jsonSchemaService
              .resolveSchemaContent(new UnresolvedSchema(schema), id, {})
      ...
      var descriptions = {
        id: configuration_localize(
          "schema.json.id",
          "A unique identifier for the schema."
        ),
        $schema: configuration_localize(
          "schema.json.$schema",
      ...
      for (var schemaName in schemaContributions.schemas) {
        ...
        for (var configuration_property in configuration_schema.properties) {
          var propertyObject =
            configuration_schema.properties[configuration_property];
          if (propertyObject === true) {
            propertyObject = configuration_schema.properties[
          ...
          switch (token) {
            ...
            case 13 /* BlockCommentTrivia */: {
              ...
              if (
                ...
                scanner.setPosition(
                  document.offsetAt(main_Position.create(startLine + 1, 0))
                );
              } else {
      ...
      function getLanguageService(params) {
        ...
        var jsonSchemaService = new jsonSchemaService_JSONSchemaService(
          params.schemaRequestService,
          params.workspaceContext,
          promise
        );
        jsonSchemaService.setSchemaContributions(schemaContributions);
        var jsonCompletion = new jsonCompletion_JSONCompletion(
          jsonSchemaService,
          params.contributions,
          promise,
          params.clientCapabilities
        );
        var jsonHover = new jsonHover_JSONHover(
          jsonSchemaService,
          params.contributions,
          promise
        );
        var jsonDocumentSymbols = new jsonDocumentSymbols_JSONDocumentSymbols(
          jsonSchemaService
        );
        var jsonValidation = new jsonValidation_JSONValidation(
          jsonSchemaService,
          promise
        );
        return {
          ...
          parseJSONDocument: function(document) {
            return jsonParser_parse(document, { collectComments: true });
          },
    ...
    /***/ URDS: /***/ function(module, exports, __webpack_require__) {
      /*!
